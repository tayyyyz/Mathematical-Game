...
namespace TRABAJOFINALALGORITMOS {
	...
	public:
		MyForm2(void)
		{
			...
			objAliado->cambia_imagen("Imagenes/Aliado2.png");

			gameService->agregarEnemigo2(bmpEnemigo->Width / 4, bmpEnemigo->Height / 4);
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void) {
			...
			this->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &MyForm2::MyForm2_KeyPress);
...
#pragma endregion
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		//BITMAP DEL MAPA
		buffer->Graphics->DrawImage(bmpMapa2, 0, 0, ancho_visible, alto_visible);
		...
		if (gameService->getVidas() == 0) {
			...
			GameOverForms2^ gameover = gcnew GameOverForms2();
		...
		if (gameService->getPuntaje() == 30) {
			timer1->Enabled = false;
			WinForms2^ wongame = gcnew WinForms2();
	...
	private: System::Void MyForm2_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e) {
